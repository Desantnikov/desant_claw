...
# TODO: move langgraph tables to separate schema
LANGGRAPH_TABLE_NAMES = ["checkpoint_blobs", "checkpoint_migrations", "checkpoint_writes", "checkpoints"]
def filter_langgraph_tables(object, name, type_, reflected, compare_to):
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        include_object=filter_langgraph_tables,
    )
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            connection=connection, target_metadata=target_metadata, include_object=filter_langgraph_tables
        )
