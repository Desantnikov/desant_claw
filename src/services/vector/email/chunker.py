...
class Chunker:
    ...
    def chunk_email(self, email_data) -> list[EmailChunk]:
        ...
        email_body = email_data['body_cleaned']
        email_words = email_body.split() if email_body else "Empty email body"

        chunks_amount = (len(email_words) // self.WORDS_PER_CHUNK_AMOUNT) + 1
