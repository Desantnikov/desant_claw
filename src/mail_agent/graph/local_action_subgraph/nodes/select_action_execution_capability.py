...
def select_action_execution_capability(state: LocalActionSubState):
    ...
    action_execution_selected_capability = action_execution_capability_selector.select_action_execution_capability()
